...
Figure 2 shows the physical layout of the design. An internal 1.5 kΩ pull-up resistor was used to ensure the active-low reset pin was not floating. The current running through the diode of the seven segment display (~1 mA) was divided by the Vcc subtracted by the forward voltage of a red LED. The output LED was connected using a 1 kΩ current-limiting resistor to ensure the output current (~2.6 mA) did not exceed the maximum output current of the FPGA I/O pins.

## Results and Discussion
The design met all intended design objectives through our testbench simulations, 

#### Testbench Simulation
![](testbench_lab1.png.png)
...
![](OSCOPE.png)
Figure 4: Screenshot of a oscilliscope waveform validating the exact frequency of 2.41 Hz. 
